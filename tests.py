...
import unittest
#import tempfile
from seduce_api.services import *
...
class FlaskrTestCase(unittest.TestCase):
	...
	def setUp(self):
		app.testing = True
		#self.db_fd, self.temp_db_location = tempfile.mkstemp()
		self.app = app.app
		with self.app.app_context():
			app.configure_app(self.app)
			#self.app.config['SQLALCHEMY_DATABASE_URI'] = self.temp_db_location
			self.app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database/db_test.sqlite'
			app.initialize_app(self.app)
			app.init_db(self.app)
...
afac="""
	def test_sensor_creation(self):
		...
		data = {"mac": "mac", "model": "model", "name": "cute sensor", "state": 0, "type": "temp"}
	...
	def test_modify_sensor(self):
		...
		databis = {"mac": "mac change", "model": "model change", "name": "cute sensor change", "state": 1, "type": "temp change"}
