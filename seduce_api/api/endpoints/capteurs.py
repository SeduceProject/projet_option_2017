...
from seduce_api.api.serializers import sensor, position, history, submit_sensor
from seduce_api.api.services import get_sensor, get_sensor_by_name, get_sensor_position, get_sensor_history, create_sensor
